...
mixin _$PomodoroStore on _PomodoroStore, Store {
  ...
  late final _$tempoFocoAtom =
      Atom(name: '_PomodoroStore.tempoFoco', context: context);

  @override
  int get tempoFoco {
    _$tempoFocoAtom.reportRead();
    return super.tempoFoco;
  }

  @override
  set tempoFoco(int value) {
    _$tempoFocoAtom.reportWrite(value, super.tempoFoco, () {
      super.tempoFoco = value;
    });
  }
  ...
  void incrementarTempoFoco() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
        name: '_PomodoroStore.incrementarTempoFoco');
    try {
      return super.incrementarTempoFoco();
    } finally {
      _$_PomodoroStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void decrementarTempoFoco() {
    final _$actionInfo = _$_PomodoroStoreActionController.startAction(
        name: '_PomodoroStore.decrementarTempoFoco');
    try {
      return super.decrementarTempoFoco();
    } finally {
      _$_PomodoroStoreActionController.endAction(_$actionInfo);
    }
  }
